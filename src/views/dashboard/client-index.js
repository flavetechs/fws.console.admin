          ...
          <div className="col-xl-3 col-lg-6">
            <div className=" card-transparent border  h-100 w-100  rounded" >
              ...
              <div className="card-body ">
                ...
                <div className="mt-5">
                  <div className=" border text-center m-n4 p-2" style={{backgroundColor : product.installed && "#f9cd39",cursor:"pointer"}} onClick={()=>history.push(`${smsLocations.sms}?productId=${product.productId}`)}>
