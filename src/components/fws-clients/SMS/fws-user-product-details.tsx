...
const UserProductDetails = () => {
  ...
  useEffect(() => {
   customisedModalValue && exportPins(customisedModalValue)(dispatch)
 }, [customisedModalValue]);
console.log("customisedModalValue",customisedModalValue);
          ...
          <div className="col-lg-3">
             ...
             <div className="card">
               ...
               <div className="card-body">
                  ...
                  <div className="twit-feed">
                     <div className="d-flex align-items-center mb-2">
                        <img className="rounded-pill img-fluid avatar-50 me-3 p-1 bg-soft-primary" src="https://templates.iqonic.design/hope-ui/html/dist/assets/images/icons/04.png" alt=""/>
                        <div className="media-support-info">
                  ...
                  <div className="twit-feed">
                     <div className="d-flex align-items-center mb-2">
                           <img className="rounded-pill img-fluid avatar-50 me-3 p-1 bg-soft-warning pt-2" src="https://templates.iqonic.design/hope-ui/html/dist/assets/images/icons/02.png" alt=""/>
                        <div className="mt-2">
                  ...
                  <div className="card">
                     ...
                     <div className="card-body p-0">
                        <div className="user-post">
                           <a href="javascript:void(0);"><img src="https://templates.iqonic.design/hope-ui/html/dist/assets/images/pages/02-page.png" alt="post-image" className="img-fluid"/></a>
                        </div>
