                  ...
                  <div className="col-lg-3">
                     ...
                     <div className="card-body">
                        ...
                        >
                           <tbody>
                              <tr>
                                 <th className="h6">Vision:</th>
                                 <th className=" h6"></th>
                              </tr>
                              <tr>
                                 <th className="h6">Mission:</th>
                                 <th className=" text-capitalize h6">

                                 </th>
                              </tr>
                              <tr>
                                 <th className="h6">School Name:</th>
                                 <th className=" text-capitalize h6">
                                    {singleUserProduct?.schoolName}
                                 </th>
                              </tr>
                              <tr>
                                 <th className="h6">Address:</th>
                                 <th className=" text-capitalize h6">
                              ...
                              <tr>
                                 <th className="h6">State:</th>
                                 <th className=" text-capitalize h6">
                                    {singleUserProduct?.state}
                                 </th>
                              </tr>
                              <tr>
                                 <th className="h6">IP Address:</th>
                                 <th className=" text-capitalize h6">
                                    {singleUserProduct?.ipAddress}
                                 </th>
                              </tr>
                              <tr>
                                 <th className="h6">Product Name:</th>
                                 <th className=" text-capitalize h6">
                                    {singleUserProduct?.productName}
                                 </th>
                              </tr>
                              <tr>
                                 <th className="h6">Product Description:</th>
                                 <th className=" text-capitalize h6">
