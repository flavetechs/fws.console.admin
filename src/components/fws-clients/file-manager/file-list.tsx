...
import { deleteFile, downloadFile, getAllFiles } from '../../../store/actions/file-manager-actions';
...
const FileList = () => {
    ...
    const { files, filterProps } = state.fileManager;
    const { deleteDialogResponse } = state.alert;
    const [indexRow, setIndexRow] = useState("");
    const [fileProps, setFileProps] = useState({ fileId: "", folderName: "" });
    ...
    // const setStateArraysAndIds = (checked:any) => {
    //     const result:any = CheckMultiple(checked, objectArray, "id");
    ...
    //delete dialog
console.log("deleteDialogResponse",selectedIds);
            ...
            <div className=" dropdown">
                <div className='d-flex justify-content-between m-2'>
                    ...
                    <button className="btn btn-sm btn-primary" onClick={(e) => {
                        ...
                        <ul className={`${showMenuDropdown && "show"} dropdown-menu `} aria-labelledby="dropdownMenu-5">
                            <li onClick={(e) => { showHideAddFolderModal(true)(dispatch) }}><a className="dropdown-item dropdown-hover" href="#" >Folder</a></li>
                ...
                <Row >
                    {files.map((file: any, idx: any) => (
                            <div className="card col-md-4 col-lg-3 mx-3 iq-file-manager">
                                <div className="card-body card-thumbnail">
                                    <a href="#" data-title="PDF" data-load-file="file" data-load-target="#resolte-contaniner" data-url="../file-manager/assets/images/doc-files/demo.pdf" data-bs-toggle="modal" data-bs-target="#file-documents">
                                        <div className="p-3 d-flex justify-content-center align-items-center iq-document rounded bg-body">
                                            ...
                                            {             //<img src="https://templates.iqonic.design/hope-ui/pro/html/file-manager/assets/images/pdf.svg" className="img-fluid" alt="pdf.svg" loading="lazy" />
                                                file.fileType == 4 ? <img src="https://templates.iqonic.design/hope-ui/pro/html/file-manager/assets/images/excel.svg" className="img-fluid" alt="excel.svg" loading="lazy" />
                                                    : file.fileType == 3 ? <img src="https://templates.iqonic.design/hope-ui/pro/html/file-manager/assets/images/word.svg" className="img-fluid" alt="word.svg" loading="lazy" />
                                    ...
                                    <div className="mt-2">
                                        ...
                                        <div className="d-flex align-items-center mb-2 text-primary gap-2">
                                            ...
                                            <p className=" mb-0 text-dark">{file.fileName.split("/")[4]}</p>
                                            <div>
                                            {showCheckBoxes ? 
                                <input
                                ...
                                />:
                                        ...
                                        <div className="d-flex justify-content-between align-items-center">
                                            <small onClick={() => { downloadFile(file.id)(dispatch) }} style={{ cursor: 'pointer' }} className="text-primary"><svg xmlns="http://www.w3.org/2000/svg" fill='currentColor' className='mx-1' width="18" height="18" viewBox="0 0 24 24"><path d="M12 21l-8-9h6v-12h4v12h6l-8 9zm9-1v2h-18v-2h-2v4h22v-4h-2z" /></svg>Download</small>
                                        </div>
                                    </div>
                                </div>
                        
                            {file.fileType == 5 &&
                                <div className="card card-folder col-md-2 col-lg-3 mx-2">
                                    <div className="card-body card-thumbnail">
                                        <div className='d-flex'>
                                            <div className="p-4 d-flex justify-content-center align-items-center iq-document rounded bg-body">
                                                <a className=" ">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="122" height="122" fill="#fece00" viewBox="0 0 24 24"><path d="M7.972 2h-6.972l.714 5h2.021l-.429-3h3.694c1.112 1.388 1.952 2 4.277 2h9.283l-.2 1h2.04l.6-3h-11.723c-1.978 0-2.041-.417-3.305-2zm16.028 7h-24l2 13h20l2-13z" /></svg>                 </a>
                                            </div>
                                            <div className="dropdown mx-4" onClick={() => {
                                                ...
                                                <ul className={`dropdown-menu ${showMenuDropdown && indexRow === idx && 'show'}`} aria-labelledby="dropdownMenu-1">
                                                    <li onClick={() => {
                                                        ...
                                                        setFileProps({ fileId: file.id, folderName: file.fileName })
                                                    }}><a className="dropdown-item" href="#">update</a></li>
                                        ...
                                        <div className="mt-4" style={{ cursor: 'pointer' }} onClick={() => { history.push(`${fileManagerLocations.fileList}?folderId=${file.id}`) }}>
                                            <h4>{file.fileName}</h4>
