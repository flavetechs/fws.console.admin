...
import { productsLocations, smsLocations } from "../../router/fws-client-path-locations";
            ...
            {userProducts?.map((product, idx) => (
              <div className="col-xl-3 col-lg-6 mt-2" key={idx}>
                <div className=" card-transparent border  h-100 w-100  rounded">
                  {" "}
                  <div className="card-body " style={{cursor:"pointer"}} onClick={()=>{history.push(`${productsLocations.userProductDetails}?userProductId=${product.productId}`)}}>
                    {" "}
                    <div className="">
